...
def test_praat_builtin_variables():
	...
	assert variables['praat_intel32'] == (platform.machine() in {'i386', 'i686', 'AMD64'} and platform.architecture()[0] == '32bit')
	assert variables['praat_intel64'] == (platform.machine() in {'x86_64', 'AMD64'} and platform.architecture()[0] == '64bit')
