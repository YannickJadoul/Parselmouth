...
def test_create(resources):
	...
	assert isinstance(parselmouth.read(resources["the_north_wind_and_the_sun.TextGrid"]), parselmouth.TextGrid)
...
def test_tgt(resources):
	...
	text_grid = parselmouth.read(text_grid_filename)  # TODO Replace with TextGrid constructor taking filename?
