...
# Until turned into a full test, also run manually like this:
#   `PYTHONPATH=build/src python3 -m pytest -s tests/test_pointprocess.py`
# Or, if preferred, add `if __name__ == '__main__': test_pointprocess()`
