...
PYBIND11_MODULE(parselmouth, m) {
	...
	m.doc() = attr_doc(m, "__version__", "This version of Parselmouth.") +
	          attr_doc(m, "VERSION", "This version of Parselmouth.") +
	          attr_doc(m, "PRAAT_VERSION", "The version of Praat on which this version of Parselmouth is based.") +
	          attr_doc(m, "PRAAT_VERSION_DATE", "The release date of the version of Praat on which this version of Parselmouth is based.");
