...
void Binding<Spectrum>::init() {
	...
	def("get_centre_of_gravity", // TODO power is POSITIVE
	    &Spectrum_getCentreOfGravity,
	    "power"_a = 2.0);

	def("get_center_of_gravity", // TODO power is POSITIVE
	    &Spectrum_getCentreOfGravity,
	    "power"_a = 2.0);

	def("get_standard_deviation", // TODO power is POSITIVE
	    &Spectrum_getStandardDeviation,
	    "power"_a = 2.0);

	def("get_skewness", // TODO power is POSITIVE
	    &Spectrum_getSkewness,
	    "power"_a = 2.0);

	def("get_kurtosis", // TODO power is POSITIVE
	    &Spectrum_getKurtosis,
	    "power"_a = 2.0);

	def("get_central_moment", // TODO moment and power are POSITIVE
	...
	def("lpc_smoothing", // TODO number of peaks NATURAL, pre emphasis POSITIVE
	    &Spectrum_lpcSmoothing,
