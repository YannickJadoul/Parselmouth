...
A `manuscript introducing Parselmouth <https://ai.vub.ac.be/%7Eyajadoul/jadoul_introducing-parselmouth_a-python-interface-to-praat.pdf>`_ has been `published in the Journal of Phonetics <https://www.sciencedirect.com/science/article/pii/S0095447017301389>`_. Scientific work and publications can for now cite Parselmouth in the following way:
