...
Since Parselmouth exposes existing Praat functionality and algorithm implementations, we suggest also `citing Praat <https://praat.org/manual/FAQ__How_to_cite_Praat.html>`_ when using Parselmouth in scientific research:
